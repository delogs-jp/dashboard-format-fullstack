/*
  ...
  - Added the required column `oldEmailPuny` to the `EmailChangeRequest` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "public"."EmailChangeRequest" ADD COLUMN     "oldEmailPuny" TEXT NOT NULL;
